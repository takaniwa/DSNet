...
class BDD(BaseDataset):
    def __init__(self, 
        ...
        super(BDD, self).__init__(ignore_label, base_size,crop_size, scale_factor, mean, std)
        ...
        self.color_list = [ [128, 64, 128], [244, 35, 232], [70, 70, 70], [102, 102, 156], [190, 153, 153], [153, 153, 153],
...
#            0, 60, 100, 0, 80, 100, 0, 0, 230, 119, 11, 32]
    ...
    def __getitem__(self, index):
        ...
        name = item["name"]
        image = Image.open(os.path.join(self.root,'bdd',item["img"])).convert('RGB')

        image = np.array(image)
        size = image.shape
        color_map = Image.open(os.path.join(self.root,'bdd',item["label"])).convert('RGB')
